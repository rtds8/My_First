...
public class Player_Controller : MonoBehaviour
{
    ...
    [SerializeField] private ParticleSystem m_PlayerBulletsLeft, m_PlayerBulletsRight;
    ...
    void FixedUpdate()
    {
        ...
        {
            GetInput();
            m_PlayerBulletsLeft.gameObject.SetActive(true);
            m_PlayerBulletsRight.gameObject.SetActive(true);
        }
    }
